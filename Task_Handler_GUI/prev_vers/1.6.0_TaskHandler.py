...
class Window(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        #Topics ################################################
        topics_names = ['Rbs','Offset','ModeManager','ActiveDischarge','ODIS','Automat']
        tN={}
        ...
        # Infrastructs
        iN['checkBox_0'].stateChanged.connect( lambda state: self.tick(state, word1 = infrastruct_names[0]) )
        iN['checkBox_1'].stateChanged.connect( lambda state: self.tick(state, word1 = infrastruct_names[1]) )
        iN['checkBox_2'].stateChanged.connect( lambda state: self.tick(state, word1 = infrastruct_names[2]) )
        iN['checkBox_3'].stateChanged.connect( lambda state: self.tick(state, word1 = infrastruct_names[3]) )
        iN['checkBox_4'].stateChanged.connect( lambda state: self.tick(state, word1 = infrastruct_names[4]) )
        # Tools
