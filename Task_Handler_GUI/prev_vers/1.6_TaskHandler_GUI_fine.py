...
class Window(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        # Projects
        checkBox_0 = QtGui.QCheckBox('VW Base +',self)
        checkBox_1 = QtGui.QCheckBox('VW Base -',self)
        checkBox_0a = QtGui.QCheckBox('S P A ', self)
        ...
        checkBox_4a = QtGui.QCheckBox('ODIS', self)
        ...
        checkBox_22a = QtGui.QCheckBox('Gerrit',self)
        # Tools
       ...
       # checkBox_ = QtGui.QCheckBox('',self)
        ...
        grid_layout.addWidget( checkBox_0a, project_line , 2)
        grid_layout.addWidget( checkBox_2, project_line , 3 )
        grid_layout.addWidget( checkBox_3, project_line , 4 )
        # Topics
        topics_line = 1
        ...
        grid_layout.addWidget ( checkBox_4a, topics_line, 4)
        # Works
        work_line = 2 
        ...
        grid_layout.addWidget( checkBox_22a , infrastuct_line , 4)         
        # Tools
        tool_line = 5
        ...
        checkBox_0a.stateChanged.connect( lambda state : self.tick(state, word1 = 'Spa'))       
        ...
        checkBox_4a.stateChanged.connect( lambda state: self.tick(state, word1 = 'Odis') )
        # Works
        miez =checkBox_0.isChecked()
        print(miez)
        ...
        checkBox_22a.stateChanged.connect( lambda state: self.tick(state, word1 = 'Gerrit') )
        # Tools
